...
```{r}
# TEMP CELDA DE PRUEBAS, SE PUEDE ELIMINAR
# df de pruebas 
# smokers_2 <- dataset
...
# Se separa el dataset en 2, por un lado se filtran todos los valores extraordinarios (altos o bajos) ya que están ligados a un problema de salud grave o a un error de medición, y en el otro dataset los valores restantes.
